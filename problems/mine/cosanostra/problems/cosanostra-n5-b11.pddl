(define (problem cosanostra-n5-b11)
  (:domain cosanostra)
  (:objects 
    b0 b1 b2 b3 b4 - toll-booth
    s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 sG - b-step
  ...
  (:init (deliverator-at shop) (pizza-at shop) (tires-intact)
    ...
    (b_next s10 sG)
    (b_next s0 s1) (b_next s1 s2) (b_next s2 s3) (b_next s3 s4) (b_next s4 s5) (b_next s5 s6) (b_next s6 s7) (b_next s7 s8) (b_next s8 s9) (b_next s9 s10)
    (bureaucracy s0))
