...
void output_typed_strips(){
  ...
  /* header
   */
  printf("(define (problem gold-miner-typed-%dx%d-s%u)",
   num_rows, num_cols, seed);
...
void output_untyped_strips(){
  ...
  /* header
   */
  printf("(define (problem gold-miner-untyped-%dx%d-s%u)",
   num_rows, num_cols, seed);
...
void usage()
{
  ...
  printf("-s <seed>   rand seed (default: time)\n\n");
