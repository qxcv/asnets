...
TRAIN_NAMES = None
TEST_RUNS = [
    # these are all training instances
    (['problems/prob_bw_n4_es1.pddl'], None),
    (['problems/prob_bw_n4_es2.pddl'], None),
    (['problems/prob_bw_n4_es3.pddl'], None),
    (['problems/prob_bw_n4_es4.pddl'], None),
    (['problems/prob_bw_n4_es5.pddl'], None),
    (['problems/prob_bw_n5_es1.pddl'], None),
    (['problems/prob_bw_n5_es2.pddl'], None),
    (['problems/prob_bw_n5_es3.pddl'], None),
    (['problems/prob_bw_n5_es4.pddl'], None),
    (['problems/prob_bw_n5_es5.pddl'], None),
    (['problems/prob_bw_n5_es6.pddl'], None),
    (['problems/prob_bw_n5_es7.pddl'], None),
    (['problems/prob_bw_n5_es8.pddl'], None),
    (['problems/prob_bw_n5_es9.pddl'], None),
    (['problems/prob_bw_n5_es10.pddl'], None),
    (['problems/prob_bw_n6_es1.pddl'], None),
    (['problems/prob_bw_n6_es2.pddl'], None),
    (['problems/prob_bw_n6_es3.pddl'], None),
    (['problems/prob_bw_n6_es4.pddl'], None),
    (['problems/prob_bw_n6_es5.pddl'], None),
    (['problems/prob_bw_n6_es6.pddl'], None),
    (['problems/prob_bw_n6_es7.pddl'], None),
    (['problems/prob_bw_n6_es8.pddl'], None),
    (['problems/prob_bw_n6_es9.pddl'], None),
    (['problems/prob_bw_n6_es10.pddl'], None),
    (['problems/prob_bw_n7_es1.pddl'], None),
    (['problems/prob_bw_n7_es2.pddl'], None),
    (['problems/prob_bw_n7_es3.pddl'], None),
    (['problems/prob_bw_n7_es4.pddl'], None),
    (['problems/prob_bw_n7_es5.pddl'], None),
    (['problems/prob_bw_n8_es1.pddl'], None),
    (['problems/prob_bw_n8_es2.pddl'], None),
    (['problems/prob_bw_n8_es3.pddl'], None),
    (['problems/prob_bw_n8_es4.pddl'], None),
    (['problems/prob_bw_n8_es5.pddl'], None),
    (['problems/prob_bw_n9_es1.pddl'], None),
    (['problems/prob_bw_n9_es2.pddl'], None),
    (['problems/prob_bw_n9_es3.pddl'], None),
    (['problems/prob_bw_n9_es4.pddl'], None),
    (['problems/prob_bw_n9_es5.pddl'], None),
    # original AAAI test instances (needed for paper) mixed with instances from
    # extended set; extended set lets us verify that net really works!
    # size 4 (orig set)
